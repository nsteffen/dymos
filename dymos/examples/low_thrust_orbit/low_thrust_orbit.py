...
spiral.add_state('p', fix_initial=True, rate_source='p_dot', lower=6378.1370+100, upper=100*6378.1, ref=6378.137, units='km')
...
p.set_val('traj.spiral.t_duration', 90000.0)
